...
ADMINS = (
     ('CMS Admin', 'admin@domain.com'),
)

MANAGERS = ADMINS

DATABASE_ENGINE = 'mysql'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'zcms'             # Or path to database file if using sqlite3.
DATABASE_USER = 'zcms'             # Not used with sqlite3.
DATABASE_PASSWORD = 'zcmsuser'         # Not used with sqlite3.
...
SECRET_KEY = 'kgonh-nr+6#v_-2d@-+$#x8i-be7p*x49gbw=kcpw3(+5v48y&'
